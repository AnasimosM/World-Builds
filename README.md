...
### ❌ You MAY NOT:
- Use these assets in **any** project without written permission
- **Modify** the meshes, textures, materials, rigs, or animations
- Redistribute, resell, or include them in asset packs
- Use them commercially or in client work
- Mint them as NFTs
- Train AI or ML models on them
- Remove or alter credit to **Anasimos Mesfin Kebede**

### ✅ You MAY:
- View the previews for evaluation
- **Request permission** to use an asset
...
Approved requests receive the files directly, with usage terms attached.
